...
missed_class = school.difference(set(attendance_list))
print(missed_class)
print(school.difference(attendance_list)) #We dont even have to convert the list into a set, Python automatically does it for us.
